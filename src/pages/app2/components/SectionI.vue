...
const columns = [
  ...
  },
  {
    name: '100',
    label: '100',
    field: (row: SectionIEntry) => row.denominations[100],
  ...
  },
  {
    name: '200',
    label: '200',
    field: (row: SectionIEntry) => row.denominations[200],
    align: 'right' as const,
    sortable: true,
  },
  {
    name: '300',
    label: '300',
    field: (row: SectionIEntry) => row.denominations[300],
    align: 'right' as const,
    sortable: true,
  },
  {
  ...
  },
  {
    name: '600',
    label: '600',
    field: (row: SectionIEntry) => row.denominations[600],
    align: 'right' as const,
    sortable: true,
  },
  {
