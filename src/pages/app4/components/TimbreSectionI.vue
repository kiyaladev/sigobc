<template>
  <div class="q-pa-md" id="timbre-section1-print">
    <div class="row items-center justify-between q-mb-md">
      <div class="col">
        <div class="text-h6">
          <q-icon name="inventory" color="purple" class="q-mr-sm" />
          Section I - Stock de Timbres (Balance d'entrée + Remises)
        </div>
      </div>
    ...
    >
      ...
      <template v-slot:body-cell-type="props">
        <q-td :props="props">
          <q-badge
            :color="
              props.row.type === 'BE-S1' ||
              props.row.type === 'Stock initial' ||
              props.row.type === 'INITIAL'
                ? 'info'
      ...
      <template v-slot:body-cell-approv="props">
        <q-td :props="props">
          <div v-if="props.row.approvisionnement" class="text-purple text-weight-bold">
