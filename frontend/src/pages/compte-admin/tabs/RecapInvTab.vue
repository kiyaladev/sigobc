<template>
  <div>
    <div class="text-center q-mb-md">
      <div class="text-h6 text-weight-bold">TITRE II - BUDGET D'INVESTISSEMENT</div>
    </div>

    <!-- RECETTES INVESTISSEMENT -->
    <div class="text-center text-weight-bold q-mb-sm">RECETTES D'INVESTISSEMENT</div>
    <q-markup-table dense bordered flat separator="cell" class="recap-table q-mb-lg">
      ...
      <tbody>
        ...
        <tr class="bg-grey-3 text-weight-bold">
          ...
          <td class="text-right">
            {{
              data.totalPrevuRecInvest.value > 0
                ? (
                    (data.totalEmissionsInvest.value / data.totalPrevuRecInvest.value) *
                    100
                  ).toFixed(2)
                : '0.00'
            }}%
    ...
    <div class="text-center text-weight-bold q-mb-sm">DEPENSES D'INVESTISSEMENT</div>
    <q-markup-table dense bordered flat separator="cell" class="recap-table">
      ...
      <tbody>
        ...
        <tr class="bg-grey-3 text-weight-bold">
          <td class="text-center">TOTAL DES DEPENSES AU TITRE II</td>
